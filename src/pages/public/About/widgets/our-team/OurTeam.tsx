...
import cls from "@src/pages/public/About/widgets/our-team/ourTeam.module.scss";
        ...
        <section className={ContainerModule.wrapper}>
            ...
            <div>
                <Slider slidesPerView={globalResize.isScreenLg ? 3 : 2} sizeBoolean={globalResize.isScreenSm} navCarets>
                    {children.map((el) => <div className={cls.container_card}>
                        <div className={cls.container_card__img}>
                            <SkeletonImageLoader src={el.src}/>
                        </div>

                        <div className={cls.container_card__text}>
