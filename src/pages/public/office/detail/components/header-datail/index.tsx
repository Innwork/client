...
import { HeaderDetailType } from "./type/headerType";
import cls from "./style/headerDetail.module.scss";

export const HeaderDeatil:FC<HeaderDetailType> = ({address, center, square}) => {
  return (
    <header className={cls.header}>
      <h1 className={TextModule.h1}>Офис №1</h1>

      <div className={cls.nav_info}>
        <div className={cls.nav_info__items}>
