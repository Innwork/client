...
import cls from "@src/pages/public/Home/components/plane/style/Plane.module.scss";
import {PlaneCardModel} from "@src/pages/public/Home/components/plane/model/PlaneCardModel";
